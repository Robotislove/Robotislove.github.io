...
![AUTOSAR总体图（较清楚细节）](https://neyzoter.cn/images/wiki/AUTOSAR/AUTOSAR_COND2.png)
...
![CanIf实现从LPDU到IPDU](https://neyzoter.cn/images/wiki/AUTOSAR/Receive_indication_interrupt_mode.png)

下图是CAN中断后发生的第2步：IPDU从Canif到PDUR，再到COM（`SWS_PDURouter.pdf` P88 CanIf module I-PDU reception）：

![IPDU从CanIf到COM](https://neyzoter.cn/images/wiki/AUTOSAR/PDUR_2_COM.png)
...
![RTE读取数据设置灯Pwm](https://neyzoter.cn/images/wiki/AUTOSAR/RTEandSWV.png)
...
![RTE变量](https://neyzoter.cn/images/wiki/AUTOSAR/variable.png)
...
* Runnable调用的函数和定义
  ...
  ![获取数据和处理](https://neyzoter.cn/images/wiki/AUTOSAR/managerRunnable.png)
  （2）执行Pwm占空比设置
  ![执行设置占空比](https://neyzoter.cn/images/wiki/AUTOSAR/actuatorRunnable.png)
  **函数定义总结**
...
![Artop架构层次](https://neyzoter.cn/images/wiki/AUTOSAR/Pg_architecturelayers.png)

**Artop 1.0 内部结构 **

![Artop架构内部](https://neyzoter.cn/images/wiki/AUTOSAR/Pg_artopcomponents_Internal.png)
