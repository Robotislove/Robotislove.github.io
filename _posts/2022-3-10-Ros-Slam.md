...
![image-20220312142358164]([![qAxlvV.md.png](https://s1.ax1x.com/2022/03/19/qAxlvV.md.png)](https://imgtu.com/i/qAxlvV))
...
![image-20220312144105745]([![qAxIr8.png](https://s1.ax1x.com/2022/03/19/qAxIr8.png)](https://imgtu.com/i/qAxIr8))
...
![image-20220312145311819]([![qAzPIJ.png](https://s1.ax1x.com/2022/03/19/qAzPIJ.png)](https://imgtu.com/i/qAzPIJ))
...
![image-20220312150053209]([![qAzMIH.png](https://s1.ax1x.com/2022/03/19/qAzMIH.png)](https://imgtu.com/i/qAzMIH))
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/477bc83deec044418ef2f42a11e7e008.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MTg2Njc4Mw==,size_16,color_FFFFFF,t_70)

```
realsense-viewer   #这是一个GUI
```

![在这里插入图片描述](https://img-blog.csdnimg.cn/a86e97fea1144bba9228d0c1a71429df.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80MTg2Njc4Mw==,size_16,color_FFFFFF,t_70)
...
而机器人中，负责导航框架（Navigation Stack）的算法包就是move_base。move_base 节点提供了一个用于配置、运行机器人上的导航堆栈并与之交互的ROS接口。move_base 的框架结构如下图所示，整个分为全局规划和局部规划，其中全局规划采用A*算法，局部规划由于小车底盘是差分，所以采用DWA局部规划与避障。![image-20220312153637212](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20220312153637212.png)
